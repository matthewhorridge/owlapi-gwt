...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link IRI}
 * objects.
 */
public class IRI_CustomFieldSerializer extends CustomFieldSerializer<IRI> {
     ...
     */
    @Override
    public IRI instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static IRI instantiate(SerializationStreamReader streamReader) throws SerializationException {
        return IRI.create(streamReader.readString());
    }
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, IRI instance) throws SerializationException {
        serialize(streamWriter, instance);
    }

    public static void serialize(SerializationStreamWriter streamWriter, IRI instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, IRI instance) throws SerializationException {
