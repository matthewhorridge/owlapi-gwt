...
/**
 * An implementation of CustomFieldSerilizer for serializing {@link OWLOntologyID}
 * objects.
 */
public class OWLOntologyID_CustomFieldSerializer extends CustomFieldSerializer<OWLOntologyID> {
     ...
     */
    @Override
    public OWLOntologyID instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, OWLOntologyID instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLOntologyID instance) throws SerializationException {
