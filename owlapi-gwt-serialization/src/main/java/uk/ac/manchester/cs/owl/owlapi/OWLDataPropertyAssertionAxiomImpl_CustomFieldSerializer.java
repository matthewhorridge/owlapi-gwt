...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLDataPropertyAssertionAxiomImpl}
 * objects.
 */
public class OWLDataPropertyAssertionAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLDataPropertyAssertionAxiomImpl> {
     ...
     */
    @Override
    public OWLDataPropertyAssertionAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLDataPropertyAssertionAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, OWLDataPropertyAssertionAxiomImpl instance) throws SerializationException {
        serialize(streamWriter, instance);
    }

    public static void serialize(SerializationStreamWriter streamWriter, OWLDataPropertyAssertionAxiomImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLDataPropertyAssertionAxiomImpl instance) throws SerializationException {
    }
}
