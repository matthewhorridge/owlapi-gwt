...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLDataExactCardinalityImpl}
 * objects.
 */
public class OWLDataExactCardinalityImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLDataExactCardinalityImpl> {
     ...
     */
    @Override
    public OWLDataExactCardinalityImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLDataExactCardinalityImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        return new OWLDataExactCardinalityImpl(property, cardinality, filler);
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLDataExactCardinalityImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLDataExactCardinalityImpl instance) throws SerializationException {
    }
}
