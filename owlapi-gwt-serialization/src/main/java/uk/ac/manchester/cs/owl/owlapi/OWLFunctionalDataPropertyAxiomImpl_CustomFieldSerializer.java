...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLFunctionalDataPropertyAxiomImpl}
 * objects.
 */
public class OWLFunctionalDataPropertyAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLFunctionalDataPropertyAxiomImpl> {
     ...
     */
    @Override
    public OWLFunctionalDataPropertyAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLFunctionalDataPropertyAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        return new OWLFunctionalDataPropertyAxiomImpl(prop, annotations);
    }
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, OWLFunctionalDataPropertyAxiomImpl instance) throws SerializationException {
        serialize(streamWriter, instance);
    }

    public static void serialize(SerializationStreamWriter streamWriter, OWLFunctionalDataPropertyAxiomImpl instance) throws SerializationException {
     ...
     */
    @Override
    public void deserializeInstance(SerializationStreamReader streamReader, OWLFunctionalDataPropertyAxiomImpl instance) throws SerializationException {
        deserialize(streamReader, instance);
    }

    public static void deserialize(SerializationStreamReader streamReader, OWLFunctionalDataPropertyAxiomImpl instance) throws SerializationException {
    }
}
