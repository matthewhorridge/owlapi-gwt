...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLDataMaxCardinalityImpl}
 * objects.
 */
public class OWLDataMaxCardinalityImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLDataMaxCardinalityImpl> {
     ...
     */
    @Override
    public OWLDataMaxCardinalityImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLDataMaxCardinalityImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        return new OWLDataMaxCardinalityImpl(property, cardinality, filler);
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLDataMaxCardinalityImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLDataMaxCardinalityImpl instance) throws SerializationException {
    }
}
