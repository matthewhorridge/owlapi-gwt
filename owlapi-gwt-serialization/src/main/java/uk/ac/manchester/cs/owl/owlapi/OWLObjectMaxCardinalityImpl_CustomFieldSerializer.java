...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLObjectMaxCardinalityImpl}
 * objects.
 */
public class OWLObjectMaxCardinalityImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLObjectMaxCardinalityImpl> {
     ...
     */
    @Override
    public OWLObjectMaxCardinalityImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLObjectMaxCardinalityImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        return new OWLObjectMaxCardinalityImpl(property, cardinality, filler);
    }
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, OWLObjectMaxCardinalityImpl instance) throws SerializationException {
        serialize(streamWriter, instance);
    }

    public static void serialize(SerializationStreamWriter streamWriter, OWLObjectMaxCardinalityImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLObjectMaxCardinalityImpl instance) throws SerializationException {
    }
}
