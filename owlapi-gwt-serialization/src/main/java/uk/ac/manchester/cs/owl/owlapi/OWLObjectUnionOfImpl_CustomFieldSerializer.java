...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLObjectUnionOfImpl}
 * objects.
 */
public class OWLObjectUnionOfImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLObjectUnionOfImpl> {
     ...
     */
    @Override
    public OWLObjectUnionOfImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLObjectUnionOfImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        return new OWLObjectUnionOfImpl(CustomFieldSerializerUtil.<OWLClassExpression>deserializeSet(streamReader));
    }
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLObjectUnionOfImpl instance) throws SerializationException {
    }
}
