...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLHasKeyAxiomImpl}
 * objects.
 */
public class OWLHasKeyAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLHasKeyAxiomImpl> {
     ...
     */
    @Override
    public OWLHasKeyAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, OWLHasKeyAxiomImpl instance) throws SerializationException {
        serialize(streamWriter, instance);
    }

    public static void serialize(SerializationStreamWriter streamWriter, OWLHasKeyAxiomImpl instance) throws SerializationException {
        CustomFieldSerializerUtil.serializeAnnotations(instance, streamWriter);
        streamWriter.writeObject(instance.getClassExpression());
        CustomFieldSerializerUtil.serializeSet(instance.getPropertyExpressions(), streamWriter);
    }
     ...
     */
    @Override
    public void deserializeInstance(SerializationStreamReader streamReader, OWLHasKeyAxiomImpl instance) throws SerializationException {
        deserialize(streamReader, instance);
    }

    public static void deserialize(SerializationStreamReader streamReader, OWLHasKeyAxiomImpl instance) throws SerializationException {
    }
}
