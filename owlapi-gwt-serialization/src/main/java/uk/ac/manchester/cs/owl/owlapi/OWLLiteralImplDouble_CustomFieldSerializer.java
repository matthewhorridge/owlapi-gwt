...
public class OWLLiteralImplDouble_CustomFieldSerializer extends CustomFieldSerializer<OWLLiteralImplDouble> {
     ...
     */
    @Override
    public OWLLiteralImplDouble instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, OWLLiteralImplDouble instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLLiteralImplDouble instance) throws SerializationException {
