...
public class OWLAnnotationAssertionAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLAnnotationAssertionAxiomImpl> {
     ...
     */
    @Override
    public OWLAnnotationAssertionAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
    ...
    public static OWLAnnotationAssertionAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        OWLAnnotationSubject subject = (OWLAnnotationSubject) streamReader.readObject();
        OWLAnnotationValue value = (OWLAnnotationValue) streamReader.readObject();
        return new OWLAnnotationAssertionAxiomImpl(subject, prop, value, annotations);
    }
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, OWLAnnotationAssertionAxiomImpl instance) throws SerializationException {
        serialize(streamWriter, instance);
    }

    public static void serialize(SerializationStreamWriter streamWriter, OWLAnnotationAssertionAxiomImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLAnnotationAssertionAxiomImpl instance) throws SerializationException {
    }
}
