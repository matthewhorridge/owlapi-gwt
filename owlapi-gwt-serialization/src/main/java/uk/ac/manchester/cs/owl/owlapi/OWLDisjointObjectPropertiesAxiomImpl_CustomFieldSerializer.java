...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLDisjointObjectPropertiesAxiomImpl}
 * objects.
 */
public class OWLDisjointObjectPropertiesAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLDisjointObjectPropertiesAxiomImpl> {
     ...
     */
    @Override
    public OWLDisjointObjectPropertiesAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLDisjointObjectPropertiesAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, OWLDisjointObjectPropertiesAxiomImpl instance) throws SerializationException {
        serialize(streamWriter, instance);
    }

    public static void serialize(SerializationStreamWriter streamWriter, OWLDisjointObjectPropertiesAxiomImpl instance) throws SerializationException {
     ...
     */
    @Override
    public void deserializeInstance(SerializationStreamReader streamReader, OWLDisjointObjectPropertiesAxiomImpl instance) throws SerializationException {
        deserialize(streamReader, instance);
    }

    public static void deserialize(SerializationStreamReader streamReader, OWLDisjointObjectPropertiesAxiomImpl instance) throws SerializationException {
    }
}
