...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLDatatypeDefinitionAxiomImpl}
 * objects.
 */
public class OWLDatatypeDefinitionAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLDatatypeDefinitionAxiomImpl> {
     ...
     */
    @Override
    public OWLDatatypeDefinitionAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLDatatypeDefinitionAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        Set<OWLAnnotation> annotations = CustomFieldSerializerUtil.deserializeAnnotations(streamReader);
        OWLDatatype dt = (OWLDatatype) streamReader.readObject();
        OWLDataRange dr = (OWLDataRange) streamReader.readObject();
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLDatatypeDefinitionAxiomImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLDatatypeDefinitionAxiomImpl instance) throws SerializationException {
    }
}
