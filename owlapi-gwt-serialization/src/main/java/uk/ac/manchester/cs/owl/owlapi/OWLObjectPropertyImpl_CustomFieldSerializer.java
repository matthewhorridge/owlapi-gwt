...
/**
 * An implementation of CustomFieldSerilizer for serializing {@link OWLObjectPropertyImpl}
 * objects.
 */
public class OWLObjectPropertyImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLObjectProperty> {
     ...
     */
    @Override
    public OWLObjectProperty instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLObjectProperty instantiate(SerializationStreamReader streamReader) throws SerializationException {
        return new OWLObjectPropertyImpl(IRI.create(streamReader.readString()));
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLObjectProperty instance) throws SerializationException {
     ...
     */
    @Override
    public void deserializeInstance(SerializationStreamReader streamReader, OWLObjectProperty instance) throws SerializationException {
        deserialize(streamReader, instance);
    }

    public static void deserialize(SerializationStreamReader streamReader, OWLObjectProperty instance) throws SerializationException {
