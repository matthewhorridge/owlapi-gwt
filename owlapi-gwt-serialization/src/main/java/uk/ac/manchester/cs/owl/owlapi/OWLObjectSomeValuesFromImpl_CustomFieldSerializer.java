...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLObjectSomeValuesFromImpl}
 * objects.
 */
public class OWLObjectSomeValuesFromImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLObjectSomeValuesFromImpl> {
     ...
     */
    @Override
    public OWLObjectSomeValuesFromImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLObjectSomeValuesFromImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        return new OWLObjectSomeValuesFromImpl(property, filler);
    }
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, OWLObjectSomeValuesFromImpl instance) throws SerializationException {
        serialize(streamWriter, instance);
    }

    public static void serialize(SerializationStreamWriter streamWriter, OWLObjectSomeValuesFromImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLObjectSomeValuesFromImpl instance) throws SerializationException {
    }
}
