...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLObjectIntersectionOfImpl}
 * objects.
 */
public class OWLObjectIntersectionOfImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLObjectIntersectionOfImpl> {
     ...
     */
    @Override
    public OWLObjectIntersectionOfImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLObjectIntersectionOfImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        return new OWLObjectIntersectionOfImpl(CustomFieldSerializerUtil.<OWLClassExpression>deserializeSet(streamReader));
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLObjectIntersectionOfImpl instance) throws SerializationException {
     ...
     */
    @Override
    public void deserializeInstance(SerializationStreamReader streamReader, OWLObjectIntersectionOfImpl instance) throws SerializationException {
        deserialize(streamReader, instance);
    }

    public static void deserialize(SerializationStreamReader streamReader, OWLObjectIntersectionOfImpl instance) throws SerializationException {
    }
}
