...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLObjectComplementOfImpl}
 * objects.
 */
public class OWLObjectComplementOfImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLObjectComplementOfImpl> {
     ...
     */
    @Override
    public OWLObjectComplementOfImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLObjectComplementOfImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        return new OWLObjectComplementOfImpl((OWLClassExpression) streamReader.readObject());
    }
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, OWLObjectComplementOfImpl instance) throws SerializationException {
     ...
     */
    @Override
    public void deserializeInstance(SerializationStreamReader streamReader, OWLObjectComplementOfImpl instance) throws SerializationException {
        deserialize(streamReader, instance);
    }

    public static void deserialize(SerializationStreamReader streamReader, OWLObjectComplementOfImpl instance) throws SerializationException {
    }
}
