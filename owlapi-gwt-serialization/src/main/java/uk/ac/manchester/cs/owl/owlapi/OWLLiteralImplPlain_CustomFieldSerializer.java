 ...
 * 24 Jul 16
 */
public class OWLLiteralImplPlain_CustomFieldSerializer extends CustomFieldSerializer<OWLLiteralImplPlain> {
     ...
     */
    @Override
    public OWLLiteralImplPlain instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLLiteralImplPlain instantiate(SerializationStreamReader streamReader) throws SerializationException {
        String literal = streamReader.readString();
        String lang = streamReader.readString();
        return new OWLLiteralImplPlain(literal, lang);
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLLiteralImplPlain instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLLiteralImplPlain instance) throws SerializationException {
