...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLClassAssertionAxiomImpl}
 * objects.
 */
public class OWLClassAssertionAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLClassAssertionAxiomImpl> {
     ...
     */
    @Override
    public OWLClassAssertionAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
    ...
    public static OWLClassAssertionAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        OWLClassExpression classExpression = (OWLClassExpression) streamReader.readObject();
        OWLIndividual individual = (OWLIndividual) streamReader.readObject();
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLClassAssertionAxiomImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLClassAssertionAxiomImpl instance) throws SerializationException {
    }
}
