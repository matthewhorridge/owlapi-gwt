 ...
 * 24 Jul 16
 */
public class OWLLiteralImplString_CustomFieldSerializer  extends CustomFieldSerializer<OWLLiteralImplString> {
     ...
     */
    @Override
    public OWLLiteralImplString instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
     ...
     */
    @Override
    public void deserializeInstance(SerializationStreamReader streamReader, OWLLiteralImplString instance) throws SerializationException {
        deserialize(streamReader, instance);
    }

    public static void deserialize(SerializationStreamReader streamReader, OWLLiteralImplString instance) throws SerializationException {
