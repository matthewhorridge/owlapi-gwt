...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLIrreflexiveObjectPropertyAxiomImpl}
 * objects.
 */
public class OWLIrreflexiveObjectPropertyAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLIrreflexiveObjectPropertyAxiomImpl> {
     ...
     */
    @Override
    public OWLIrreflexiveObjectPropertyAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
    ...
    public static OWLIrreflexiveObjectPropertyAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        return new OWLIrreflexiveObjectPropertyAxiomImpl(prop, annotations);
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLIrreflexiveObjectPropertyAxiomImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLIrreflexiveObjectPropertyAxiomImpl instance) throws SerializationException {
    }
}
