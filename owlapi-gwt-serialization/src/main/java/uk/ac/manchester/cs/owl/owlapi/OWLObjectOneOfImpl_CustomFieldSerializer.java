...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLObjectOneOfImpl}
 * objects.
 */
public class OWLObjectOneOfImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLObjectOneOfImpl> {
     ...
     */
    @Override
    public OWLObjectOneOfImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLObjectOneOfImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        return new OWLObjectOneOfImpl(CustomFieldSerializerUtil.<OWLIndividual>deserializeSet(streamReader));
    }
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, OWLObjectOneOfImpl instance) throws SerializationException {
        serialize(streamWriter, instance);
    }

    public static void serialize(SerializationStreamWriter streamWriter, OWLObjectOneOfImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLObjectOneOfImpl instance) throws SerializationException {
    }
}
