 ...
 * objects.
 */
public class OWLClassImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLClass> {
     ...
     */
    @Override
    public OWLClass instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLClass instantiate(SerializationStreamReader streamReader) throws SerializationException {
        return new OWLClassImpl(IRI.create(streamReader.readString()));
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLClass instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLClass instance) throws SerializationException {
