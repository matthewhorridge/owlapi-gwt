...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLDisjointDataPropertiesAxiomImpl}
 * objects.
 */
public class OWLDisjointDataPropertiesAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLDisjointDataPropertiesAxiomImpl> {
     ...
     */
    @Override
    public OWLDisjointDataPropertiesAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLDisjointDataPropertiesAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLDisjointDataPropertiesAxiomImpl instance) throws SerializationException {
     ...
     */
    @Override
    public void deserializeInstance(SerializationStreamReader streamReader, OWLDisjointDataPropertiesAxiomImpl instance) throws SerializationException {
        deserialize(streamReader, instance);
    }

    public static void deserialize(SerializationStreamReader streamReader, OWLDisjointDataPropertiesAxiomImpl instance) throws SerializationException {
    }
}
