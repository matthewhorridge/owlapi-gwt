...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLDataMinCardinalityImpl}
 * objects.
 */
public class OWLDataMinCardinalityImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLDataMinCardinalityImpl> {
     ...
     */
    @Override
    public OWLDataMinCardinalityImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLDataMinCardinalityImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        return new OWLDataMinCardinalityImpl(property, cardinality, filler);
    }
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, OWLDataMinCardinalityImpl instance) throws SerializationException {
        serialize(streamWriter, instance);
    }

    public static void serialize(SerializationStreamWriter streamWriter, OWLDataMinCardinalityImpl instance) throws SerializationException {
     ...
     */
    @Override
    public void deserializeInstance(SerializationStreamReader streamReader, OWLDataMinCardinalityImpl instance) throws SerializationException {
        deserialize(streamReader, instance);
    }

    public static void deserialize(SerializationStreamReader streamReader, OWLDataMinCardinalityImpl instance) throws SerializationException {
    }
}
