...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLNegativeObjectPropertyAssertionAxiomImpl}
 * objects.
 */
public class OWLNegativeObjectPropertyAssertionAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLNegativeObjectPropertyAssertionAxiomImpl> {
     ...
     */
    @Override
    public OWLNegativeObjectPropertyAssertionAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLNegativeObjectPropertyAssertionAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        OWLIndividual object = (OWLIndividual) streamReader.readObject();
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLNegativeObjectPropertyAssertionAxiomImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLNegativeObjectPropertyAssertionAxiomImpl instance) throws SerializationException {
    }
}
