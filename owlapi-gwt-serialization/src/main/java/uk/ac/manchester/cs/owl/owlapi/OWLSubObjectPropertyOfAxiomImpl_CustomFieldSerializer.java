...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLSubObjectPropertyOfAxiomImpl}
 * objects.
 */
public class OWLSubObjectPropertyOfAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLSubObjectPropertyOfAxiomImpl> {
     ...
     */
    @Override
    public OWLSubObjectPropertyOfAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLSubObjectPropertyOfAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        Set<OWLAnnotation> annotations = CustomFieldSerializerUtil.deserializeAnnotations(streamReader);
        OWLObjectPropertyExpression subProp = (OWLObjectPropertyExpression) streamReader.readObject();
        OWLObjectPropertyExpression superProp = (OWLObjectPropertyExpression) streamReader.readObject();
        return new OWLSubObjectPropertyOfAxiomImpl(subProp, superProp, annotations);
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLSubObjectPropertyOfAxiomImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLSubObjectPropertyOfAxiomImpl instance) throws SerializationException {
    }
}
