...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLDatatypeRestrictionImpl}
 * objects.
 */
public class OWLDatatypeRestrictionImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLDatatypeRestrictionImpl> {
     ...
     */
    @Override
    public OWLDatatypeRestrictionImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLDatatypeRestrictionImpl instance) throws SerializationException {
        streamWriter.writeObject(instance.getDatatype());
        CustomFieldSerializerUtil.serializeSet(instance.getFacetRestrictions(), streamWriter);
    }
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLDatatypeRestrictionImpl instance) throws SerializationException {
    }
}
