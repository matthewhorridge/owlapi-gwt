...
/**
 * An implementation of CustomFieldSerilizer for serializing {@link OWLNamedIndividualImpl}
 * objects.
 */
public class OWLNamedIndividualImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLNamedIndividualImpl> {
     ...
     */
    @Override
    public OWLNamedIndividualImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLNamedIndividualImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        return new OWLNamedIndividualImpl(IRI.create(streamReader.readString()));
    }
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, OWLNamedIndividualImpl instance) throws SerializationException {
        serialize(streamWriter, instance);
    }

    public static void serialize(SerializationStreamWriter streamWriter, OWLNamedIndividualImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLNamedIndividualImpl instance) throws SerializationException {
