...
/**
 * An implementation of CustomFieldSerilizer for serializing {@link OWLImportsDeclarationImpl}
 * objects.
 */
public class OWLImportsDeclarationImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLImportsDeclarationImpl> {
     ...
     */
    @Override
    public OWLImportsDeclarationImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLImportsDeclarationImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        return new OWLImportsDeclarationImpl(IRI.create(streamReader.readString()));
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLImportsDeclarationImpl instance) throws SerializationException {
     ...
     */
    @Override
    public void deserializeInstance(SerializationStreamReader streamReader, OWLImportsDeclarationImpl instance) throws SerializationException {
        deserialize(streamReader, instance);
    }

    public static void deserialize(SerializationStreamReader streamReader, OWLImportsDeclarationImpl instance) throws SerializationException {
