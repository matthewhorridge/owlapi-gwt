...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLNegativeDataPropertyAssertionAxiomImpl}
 * objects.
 */
public class OWLNegativeDataPropertyAssertionAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLNegativeDataPropertyAssertionAxiomImpl> {
     ...
     */
    @Override
    public OWLNegativeDataPropertyAssertionAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLNegativeDataPropertyAssertionAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        Set<OWLAnnotation> annotations = CustomFieldSerializerUtil.deserializeAnnotations(streamReader);
        OWLIndividual subject = (OWLIndividual) streamReader.readObject();
        OWLDataPropertyExpression property = (OWLDataPropertyExpression) streamReader.readObject();
        OWLLiteral object = (OWLLiteral) streamReader.readObject();
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, OWLNegativeDataPropertyAssertionAxiomImpl instance) throws SerializationException {
        serialize(streamWriter, instance);
    }

    public static void serialize(SerializationStreamWriter streamWriter, OWLNegativeDataPropertyAssertionAxiomImpl instance) throws SerializationException {
        CustomFieldSerializerUtil.serializeAnnotations(instance, streamWriter);
        streamWriter.writeObject(instance.getSubject());
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLNegativeDataPropertyAssertionAxiomImpl instance) throws SerializationException {
    }
}
