...
public class OWLLiteralImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLLiteralImpl> {
     ...
     */
    @Override
    public OWLLiteralImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLLiteralImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        return new OWLLiteralImpl(literal, lang, datatype);
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLLiteralImpl instance) throws SerializationException {
     ...
     */
    @Override
    public void deserializeInstance(SerializationStreamReader streamReader, OWLLiteralImpl instance) throws SerializationException {
        deserialize(streamReader, instance);
    }

    public static void deserialize(SerializationStreamReader streamReader, OWLLiteralImpl instance) throws SerializationException {
