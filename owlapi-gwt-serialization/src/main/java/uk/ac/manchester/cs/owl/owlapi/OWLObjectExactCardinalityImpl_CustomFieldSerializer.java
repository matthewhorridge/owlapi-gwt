...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLObjectExactCardinalityImpl}
 * objects.
 */
public class OWLObjectExactCardinalityImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLObjectExactCardinalityImpl> {
     ...
     */
    @Override
    public OWLObjectExactCardinalityImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLObjectExactCardinalityImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        return new OWLObjectExactCardinalityImpl(property, cardinality, filler);
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLObjectExactCardinalityImpl instance) throws SerializationException {
     ...
     */
    @Override
    public void deserializeInstance(SerializationStreamReader streamReader, OWLObjectExactCardinalityImpl instance) throws SerializationException {
        deserialize(streamReader, instance);
    }

    public static void deserialize(SerializationStreamReader streamReader, OWLObjectExactCardinalityImpl instance) throws SerializationException {
    }
}
