...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLReflexiveObjectPropertyAxiomImpl}
 * objects.
 */
public class OWLReflexiveObjectPropertyAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLReflexiveObjectPropertyAxiomImpl> {
     ...
     */
    @Override
    public OWLReflexiveObjectPropertyAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLReflexiveObjectPropertyAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        return new OWLReflexiveObjectPropertyAxiomImpl(prop, annotations);
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLReflexiveObjectPropertyAxiomImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLReflexiveObjectPropertyAxiomImpl instance) throws SerializationException {
    }
}
