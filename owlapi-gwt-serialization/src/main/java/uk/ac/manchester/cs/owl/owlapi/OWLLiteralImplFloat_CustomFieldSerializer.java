 ...
 * 24 Jul 16
 */
public class OWLLiteralImplFloat_CustomFieldSerializer extends CustomFieldSerializer<OWLLiteralImplFloat> {

    public static final OWL2DatatypeImpl DATATYPE = new OWL2DatatypeImpl(OWL2Datatype.XSD_FLOAT);
     ...
     */
    @Override
    public OWLLiteralImplFloat instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLLiteralImplFloat instantiate(SerializationStreamReader streamReader) throws SerializationException {
        return new OWLLiteralImplFloat(streamReader.readFloat(), DATATYPE);
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLLiteralImplFloat instance) throws SerializationException {
        streamWriter.writeFloat(instance.parseFloat());
    }
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLLiteralImplFloat instance) throws SerializationException {
