...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLObjectPropertyAssertionAxiomImpl}
 * objects.
 */
public class OWLObjectPropertyAssertionAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLObjectPropertyAssertionAxiomImpl> {
     ...
     */
    @Override
    public OWLObjectPropertyAssertionAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLObjectPropertyAssertionAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLObjectPropertyAssertionAxiomImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLObjectPropertyAssertionAxiomImpl instance) throws SerializationException {
    }
}
