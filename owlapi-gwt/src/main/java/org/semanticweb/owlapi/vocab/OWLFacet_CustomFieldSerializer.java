...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link OWLFacet}
 * objects.
 */
public class OWLFacet_CustomFieldSerializer extends CustomFieldSerializer<OWLFacet> {
     ...
     */
    @Override
    public OWLFacet instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, OWLFacet instance) throws SerializationException {
