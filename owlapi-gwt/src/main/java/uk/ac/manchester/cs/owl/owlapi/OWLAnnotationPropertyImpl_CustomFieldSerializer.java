...
/**
 * An implementation of CustomFieldSerilizer for serializing {@link OWLAnnotationPropertyImpl}
 * objects.
 */
public class OWLAnnotationPropertyImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLAnnotationPropertyImpl> {
     ...
     */
    @Override
    public OWLAnnotationPropertyImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLAnnotationPropertyImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        return new OWLAnnotationPropertyImpl(IRI.create(streamReader.readString()));
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLAnnotationPropertyImpl instance) throws SerializationException {
     ...
     */
    @Override
    public void deserializeInstance(SerializationStreamReader streamReader, OWLAnnotationPropertyImpl instance) throws SerializationException {
        deserialize(streamReader, instance);
    }

    public static void deserialize(SerializationStreamReader streamReader, OWLAnnotationPropertyImpl instance) throws SerializationException {
