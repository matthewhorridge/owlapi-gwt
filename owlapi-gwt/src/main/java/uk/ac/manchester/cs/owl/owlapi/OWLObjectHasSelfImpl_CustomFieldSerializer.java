...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLObjectHasSelfImpl}
 * objects.
 */
public class OWLObjectHasSelfImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLObjectHasSelfImpl> {
     ...
     */
    @Override
    public OWLObjectHasSelfImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLObjectHasSelfImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        return new OWLObjectHasSelfImpl((OWLObjectPropertyExpression) streamReader.readObject());
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLObjectHasSelfImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLObjectHasSelfImpl instance) throws SerializationException {
    }
}
