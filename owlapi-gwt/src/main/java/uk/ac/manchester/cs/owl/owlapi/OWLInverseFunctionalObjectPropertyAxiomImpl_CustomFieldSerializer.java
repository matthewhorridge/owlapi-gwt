...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLInverseFunctionalObjectPropertyAxiomImpl}
 * objects.
 */
public class OWLInverseFunctionalObjectPropertyAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLInverseFunctionalObjectPropertyAxiomImpl> {
     ...
     */
    @Override
    public OWLInverseFunctionalObjectPropertyAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLInverseFunctionalObjectPropertyAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        return new OWLInverseFunctionalObjectPropertyAxiomImpl(prop, annotations);
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLInverseFunctionalObjectPropertyAxiomImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLInverseFunctionalObjectPropertyAxiomImpl instance) throws SerializationException {
    }
}
