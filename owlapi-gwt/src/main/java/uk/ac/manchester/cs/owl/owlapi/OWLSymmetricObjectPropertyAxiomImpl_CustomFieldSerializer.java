...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link OWLSymmetricObjectPropertyAxiomImpl}
 * objects.
 */
public class OWLSymmetricObjectPropertyAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLSymmetricObjectPropertyAxiomImpl> {
    /**
     ...
     */
    @Override
    public OWLSymmetricObjectPropertyAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLSymmetricObjectPropertyAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        return new OWLSymmetricObjectPropertyAxiomImpl(prop, annotations);
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLSymmetricObjectPropertyAxiomImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLSymmetricObjectPropertyAxiomImpl instance) throws SerializationException {
    }
}
