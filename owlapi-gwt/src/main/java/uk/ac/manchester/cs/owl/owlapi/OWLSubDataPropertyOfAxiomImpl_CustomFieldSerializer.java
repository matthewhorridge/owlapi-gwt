...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLSubDataPropertyOfAxiomImpl}
 * objects.
 */
public class OWLSubDataPropertyOfAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLSubDataPropertyOfAxiomImpl> {
     ...
     */
    @Override
    public OWLSubDataPropertyOfAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLSubDataPropertyOfAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        Set<OWLAnnotation> annotations = CustomFieldSerializerUtil.deserializeAnnotations(streamReader);
        OWLDataPropertyExpression subProp = (OWLDataPropertyExpression) streamReader.readObject();
        OWLDataPropertyExpression superProp = (OWLDataPropertyExpression) streamReader.readObject();
        return new OWLSubDataPropertyOfAxiomImpl(subProp, superProp, annotations);
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLSubDataPropertyOfAxiomImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLSubDataPropertyOfAxiomImpl instance) throws SerializationException {
    }
}
