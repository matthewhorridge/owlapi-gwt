...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLObjectPropertyRangeAxiomImpl}
 * objects.
 */
public class OWLObjectPropertyRangeAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLObjectPropertyRangeAxiomImpl> {
     ...
     */
    @Override
    public OWLObjectPropertyRangeAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLObjectPropertyRangeAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        return new OWLObjectPropertyRangeAxiomImpl(prop, dom, annotations);
    }
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, OWLObjectPropertyRangeAxiomImpl instance) throws SerializationException {
        serialize(streamWriter, instance);
    }

    public static void serialize(SerializationStreamWriter streamWriter, OWLObjectPropertyRangeAxiomImpl instance) throws SerializationException {
        CustomFieldSerializerUtil.serializeAnnotations(instance, streamWriter);
        streamWriter.writeObject(instance.getProperty());
        streamWriter.writeObject(instance.getRange());
    }
     ...
     */
    @Override
    public void deserializeInstance(SerializationStreamReader streamReader, OWLObjectPropertyRangeAxiomImpl instance) throws SerializationException {
        deserialize(streamReader, instance);
    }

    public static void deserialize(SerializationStreamReader streamReader, OWLObjectPropertyRangeAxiomImpl instance) throws SerializationException {
    }
}
