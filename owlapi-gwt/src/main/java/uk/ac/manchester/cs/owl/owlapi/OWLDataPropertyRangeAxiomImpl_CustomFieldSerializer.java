...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLDataPropertyRangeAxiomImpl}
 * objects.
 */
public class OWLDataPropertyRangeAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLDataPropertyRangeAxiomImpl> {
     ...
     */
    @Override
    public OWLDataPropertyRangeAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
    ...
    public static OWLDataPropertyRangeAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        OWLDataRange dom = (OWLDataRange) streamReader.readObject();
        return new OWLDataPropertyRangeAxiomImpl(prop, dom, annotations);
    }
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, OWLDataPropertyRangeAxiomImpl instance) throws SerializationException {
        serialize(streamWriter, instance);
    }

    public static void serialize(SerializationStreamWriter streamWriter, OWLDataPropertyRangeAxiomImpl instance) throws SerializationException {
     ...
     */
    @Override
    public void deserializeInstance(SerializationStreamReader streamReader, OWLDataPropertyRangeAxiomImpl instance) throws SerializationException {
        deserialize(streamReader, instance);
    }

    public static void deserialize(SerializationStreamReader streamReader, OWLDataPropertyRangeAxiomImpl instance) throws SerializationException {
    }
}
