...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLDifferentIndividualsAxiomImpl}
 * objects.
 */
public class OWLDifferentIndividualsAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLDifferentIndividualsAxiomImpl> {
     ...
     */
    @Override
    public OWLDifferentIndividualsAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLDifferentIndividualsAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLDifferentIndividualsAxiomImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLDifferentIndividualsAxiomImpl instance) throws SerializationException {
    }
}
