...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLObjectInverseOfImpl}
 * objects.
 */
public class OWLObjectInverseOfImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLObjectInverseOfImpl> {
     ...
     */
    @Override
    public OWLObjectInverseOfImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLObjectInverseOfImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLObjectInverseOfImpl instance) throws SerializationException {
        streamWriter.writeObject(instance.getInverse());
    }
     ...
     */
    @Override
    public void deserializeInstance(SerializationStreamReader streamReader, OWLObjectInverseOfImpl instance) throws SerializationException {
        deserialize(streamReader, instance);
    }

    public static void deserialize(SerializationStreamReader streamReader, OWLObjectInverseOfImpl instance) throws SerializationException {
    }
}
