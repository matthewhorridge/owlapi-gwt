...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLAnnotationPropertyRangeAxiomImpl}
 * objects.
 */
public class OWLAnnotationPropertyRangeAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLAnnotationPropertyRangeAxiomImpl> {
     ...
     */
    @Override
    public OWLAnnotationPropertyRangeAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
    ...
    public static OWLAnnotationPropertyRangeAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        return new OWLAnnotationPropertyRangeAxiomImpl(prop, dom, annotations);
    }
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, OWLAnnotationPropertyRangeAxiomImpl instance) throws SerializationException {
        serialize(streamWriter, instance);
    }

    public static void serialize(SerializationStreamWriter streamWriter, OWLAnnotationPropertyRangeAxiomImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLAnnotationPropertyRangeAxiomImpl instance) throws SerializationException {
    }
}
