...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLAsymmetricObjectPropertyAxiomImpl}
 * objects.
 */
public class OWLAsymmetricObjectPropertyAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLAsymmetricObjectPropertyAxiomImpl> {
     ...
     */
    @Override
    public OWLAsymmetricObjectPropertyAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLAsymmetricObjectPropertyAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        return new OWLAsymmetricObjectPropertyAxiomImpl(prop, annotations);
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLAsymmetricObjectPropertyAxiomImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLAsymmetricObjectPropertyAxiomImpl instance) throws SerializationException {
    }
}
