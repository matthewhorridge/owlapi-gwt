...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLFacetRestrictionImpl}
 * objects.
 */
public class OWLFacetRestrictionImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLFacetRestrictionImpl> {
     ...
     */
    @Override
    public OWLFacetRestrictionImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLFacetRestrictionImpl instance) throws SerializationException {
        streamWriter.writeInt(instance.getFacet().ordinal());
        streamWriter.writeObject(instance.getFacetValue());
    }
     ...
     */
    @Override
    public void deserializeInstance(SerializationStreamReader streamReader, OWLFacetRestrictionImpl instance) throws SerializationException {
        deserialize(streamReader, instance);
    }

    public static void deserialize(SerializationStreamReader streamReader, OWLFacetRestrictionImpl instance) throws SerializationException {
    }
}
