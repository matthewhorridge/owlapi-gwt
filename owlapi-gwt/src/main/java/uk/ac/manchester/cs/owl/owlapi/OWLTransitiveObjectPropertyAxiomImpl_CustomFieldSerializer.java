...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLTransitiveObjectPropertyAxiomImpl}
 * objects.
 */
public class OWLTransitiveObjectPropertyAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLTransitiveObjectPropertyAxiomImpl> {
     ...
     */
    @Override
    public OWLTransitiveObjectPropertyAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLTransitiveObjectPropertyAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        return new OWLTransitiveObjectPropertyAxiomImpl(prop, annotations);
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLTransitiveObjectPropertyAxiomImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLTransitiveObjectPropertyAxiomImpl instance) throws SerializationException {
    }
}
