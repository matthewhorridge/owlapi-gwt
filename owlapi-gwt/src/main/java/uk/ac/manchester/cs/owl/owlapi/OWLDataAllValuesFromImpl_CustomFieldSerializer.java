...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link OWLDataAllValuesFrom}
 * objects.
 */
public class OWLDataAllValuesFromImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLDataAllValuesFromImpl> {
     ...
     */
    @Override
    public OWLDataAllValuesFromImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLDataAllValuesFromImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
     ...
     */
    @Override
    public void serializeInstance(SerializationStreamWriter streamWriter, OWLDataAllValuesFromImpl instance) throws SerializationException {
        serialize(streamWriter, instance);
    }

    public static void serialize(SerializationStreamWriter streamWriter, OWLDataAllValuesFromImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLDataAllValuesFromImpl instance) throws SerializationException {
    }
}
