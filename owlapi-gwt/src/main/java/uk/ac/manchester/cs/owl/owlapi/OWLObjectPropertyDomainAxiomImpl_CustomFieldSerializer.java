...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLObjectPropertyDomainAxiomImpl}
 * objects.
 */
public class OWLObjectPropertyDomainAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLObjectPropertyDomainAxiomImpl> {
     ...
     */
    @Override
    public OWLObjectPropertyDomainAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLObjectPropertyDomainAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        return new OWLObjectPropertyDomainAxiomImpl(prop, dom, annotations);
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLObjectPropertyDomainAxiomImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLObjectPropertyDomainAxiomImpl instance) throws SerializationException {
    }
}
