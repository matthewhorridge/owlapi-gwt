...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLObjectAllValuesFromImpl}
 * objects.
 */
public class OWLObjectAllValuesFromImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLObjectAllValuesFromImpl> {
     ...
     */
    @Override
    public OWLObjectAllValuesFromImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLObjectAllValuesFromImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
        ...
        return new OWLObjectAllValuesFromImpl(property, filler);
    }
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLObjectAllValuesFromImpl instance) throws SerializationException {
    ...
    public static void deserialize(SerializationStreamReader streamReader, OWLObjectAllValuesFromImpl instance) throws SerializationException {
    }
}
