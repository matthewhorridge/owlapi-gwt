...
/**
 * A server side implementation of CustomFieldSerilizer for serializing {@link uk.ac.manchester.cs.owl.owlapi.OWLDisjointClassesAxiomImpl}
 * objects.
 */
public class OWLDisjointClassesAxiomImpl_CustomFieldSerializer extends CustomFieldSerializer<OWLDisjointClassesAxiomImpl> {
     ...
     */
    @Override
    public OWLDisjointClassesAxiomImpl instantiateInstance(SerializationStreamReader streamReader) throws SerializationException {
        return instantiate(streamReader);
    }

    public static OWLDisjointClassesAxiomImpl instantiate(SerializationStreamReader streamReader) throws SerializationException {
    ...
    public static void serialize(SerializationStreamWriter streamWriter, OWLDisjointClassesAxiomImpl instance) throws SerializationException {
     ...
     */
    @Override
    public void deserializeInstance(SerializationStreamReader streamReader, OWLDisjointClassesAxiomImpl instance) throws SerializationException {
        deserialize(streamReader, instance);
    }

    public static void deserialize(SerializationStreamReader streamReader, OWLDisjointClassesAxiomImpl instance) throws SerializationException {
    }
}
